...
public partial class MemLogin : System.Web.UI.Page
{
    ...
    {
 SqlCommand cmd = new SqlCommand("select * from TBL_REG where Login='" + TextBox1.Text + "'and Password='" + TextBox2.Text + "' and Status='0'", con);
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                SqlCommand cm = new SqlCommand("update TBL_TEME set Login='" + TextBox1.Text + "', Password='" + TextBox2.Text + "' where Id= '1' ", con);
                cmd.CommandType = CommandType.Text;
