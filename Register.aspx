...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%">
        <caption style="font-size: large; color: #FF0000; text-align: left">
            <strong>Register Member</strong></caption>
        <tr>
...
&nbsp;<asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="TextBox5" ErrorMessage="Invalid date" ForeColor="#FF3300" MaximumValue="1/7/2000" MinimumValue="1/7/1950" Type="Date">*</asp:RangeValidator>
        ...
        <tr>
            <td style="color: #993399"><b>Mobile1</b></td>
            <td>
        ...
        <tr>
            <td style="color: #993399"><b>Mobile2</b></td>
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox7" ErrorMessage="Invalid Phone no" ForeColor="Red" ValidationExpression="\d{10}">*</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="TextBox8" ErrorMessage="Invalid aadhar no" ForeColor="Red" ValidationExpression="\d{12}">*</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td style="color: #993399"><b>Email</b></td>
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TextBox9" ErrorMessage="invalid email" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">*</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td style="color: #993399"><b>DoR</b></td>
            <td>
        ...
        <tr>
            <td style="color: #993399; height: 26px"><b>Password</b></td>
            <td style="height: 26px">
                <asp:TextBox ID="TextBox12" runat="server" TextMode="Password"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" BackColor="White" ControlToValidate="TextBox12" ErrorMessage="Enter the pasword" ForeColor="Red">*</asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="TextBox13" ControlToValidate="TextBox12" ErrorMessage="Enter the paasword correctly" ForeColor="Red">*</asp:CompareValidator>
            </td>
        </tr>
        <tr>
            <td style="color: #993399; height: 26px"><b>Confirm Password</b></td>
            <td style="height: 26px">
                <asp:TextBox ID="TextBox13" runat="server" TextMode="Password"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" BackColor="White" ControlToValidate="TextBox13" ErrorMessage="Enter the password" ForeColor="Red">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" BackColor="#CC3300" BorderColor="#CC3300" ForeColor="#FFCCCC" OnClick="Button1_Click" Text="Register" />
            </td>
        </tr>
        <tr>
            <td>
