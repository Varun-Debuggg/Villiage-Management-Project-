<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CizitenLogin.aspx.cs" Inherits="CizitenLogin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%" >
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" Text="Login" BackColor="#993300" ForeColor="#FFCC99" OnClick="Button1_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
